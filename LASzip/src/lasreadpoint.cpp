...
LAStools::BOOL LASreadPoint::setup(U32 num_items, const LASitem* items, const LASzip* laszip)
{
  U32 i;
...
LAStools::BOOL LASreadPoint::init(ByteStreamIn* instream)
{
...
LAStools::BOOL LASreadPoint::seek(const U32 current, const U32 target)
{
...
LAStools::BOOL LASreadPoint::read(U8* const * point)
{
  U32 i;
  U32 context = 0;
...
LAStools::BOOL LASreadPoint::check_end()
{
...
LAStools::BOOL LASreadPoint::done()
{
  instream = 0;
  return TRUE;
}

LAStools::BOOL LASreadPoint::init_dec()
{
...
LAStools::BOOL LASreadPoint::read_chunk_table()
{
