...
LAStools::BOOL LASwriteItemCompressed_POINT10_v1::init(const U8* item, U32& context)
{
  U32 i;
...
inline LAStools::BOOL LASwriteItemCompressed_POINT10_v1::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_GPSTIME11_v1::init(const U8* item, U32& context)
{
  /* init state */
  last_gpstime_diff = 0;
...
inline LAStools::BOOL LASwriteItemCompressed_GPSTIME11_v1::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_RGB12_v1::init(const U8* item, U32& context)
{
  /* init state */
...
inline LAStools::BOOL LASwriteItemCompressed_RGB12_v1::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_WAVEPACKET13_v1::init(const U8* item, U32& context)
{
  /* init state */
  last_diff_32 = 0;
...
inline LAStools::BOOL LASwriteItemCompressed_WAVEPACKET13_v1::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_BYTE_v1::init(const U8* item, U32& context)
{
  /* init state */
...
inline LAStools::BOOL LASwriteItemCompressed_BYTE_v1::write(const U8* item, U32& context)
{
  U32 i;
  for (i = 0; i < number; i++)
  {
