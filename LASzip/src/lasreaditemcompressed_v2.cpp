...
LAStools::BOOL LASreadItemCompressed_POINT10_v2::init(const U8* item, U32& context)
{
  U32 i;
...
LAStools::BOOL LASreadItemCompressed_GPSTIME11_v2::init(const U8* item, U32& context)
{
  /* init state */
  last = 0, next = 0;
...
LAStools::BOOL LASreadItemCompressed_RGB12_v2::init(const U8* item, U32& context)
{
  /* init state */
...
LAStools::BOOL LASreadItemCompressed_BYTE_v2::init(const U8* item, U32& context)
{
  U32 i;
  /* init state */
