...
public:
/* write single bits                                         */
  inline LAStools::BOOL putBits(U32 bits, U32 num_bits)
  {
    U64 new_bits = bits;
...
/* called after writing bits before closing or writing bytes */
  inline LAStools::BOOL flushBits()
  {
    if (num_buffer)
    {
...
/* write a single byte                                       */
  virtual LAStools::BOOL putByte(U8 byte) = 0;
/* write an array of bytes                                   */
  virtual LAStools::BOOL putBytes(const U8* bytes, U32 num_bytes) = 0;
/* write 16 bit low-endian field                             */
  virtual LAStools::BOOL put16bitsLE(const U8* bytes) = 0;
/* write 32 bit low-endian field                             */
  virtual LAStools::BOOL put32bitsLE(const U8* bytes) = 0;
/* write 64 bit low-endian field                             */
  virtual LAStools::BOOL put64bitsLE(const U8* bytes) = 0;
/* write 16 bit big-endian field                             */
  virtual LAStools::BOOL put16bitsBE(const U8* bytes) = 0;
/* write 32 bit big-endian field                             */
  virtual LAStools::BOOL put32bitsBE(const U8* bytes) = 0;
/* write 64 bit big-endian field                             */
  virtual LAStools::BOOL put64bitsBE(const U8* bytes) = 0;
...
/* seek to the end of the file                               */
  virtual LAStools::BOOL seekEnd() = 0;
/* constructor                                               */
