...
LAStools::BOOL LASreadItemCompressed_POINT14_v3::chunk_sizes()
{
...
LAStools::BOOL LASreadItemCompressed_POINT14_v3::init(const U8* item, U32& context)
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_RGB14_v3::chunk_sizes()
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_RGB14_v3::init(const U8* item, U32& context)
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_RGBNIR14_v3::chunk_sizes()
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_RGBNIR14_v3::init(const U8* item, U32& context)
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_WAVEPACKET14_v3::chunk_sizes()
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_WAVEPACKET14_v3::init(const U8* item, U32& context)
{
  /* for layered compression 'dec' only hands over the stream */
...
LAStools::BOOL LASreadItemCompressed_BYTE14_v3::chunk_sizes()
{
  U32 i;
...
LAStools::BOOL LASreadItemCompressed_BYTE14_v3::init(const U8* item, U32& context)
{
  U32 i;
