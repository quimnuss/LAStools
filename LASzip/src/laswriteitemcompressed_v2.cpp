...
LAStools::BOOL LASwriteItemCompressed_POINT10_v2::init(const U8* item, U32& context)
{
  U32 i;
...
inline LAStools::BOOL LASwriteItemCompressed_POINT10_v2::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_GPSTIME11_v2::init(const U8* item, U32& context)
{
  /* init state */
  last = 0, next = 0;
...
inline LAStools::BOOL LASwriteItemCompressed_GPSTIME11_v2::write(const U8* item, U32& context)
{
...
LAStools::BOOL LASwriteItemCompressed_RGB12_v2::init(const U8* item, U32& context)
{
  /* init state */
...
inline LAStools::BOOL LASwriteItemCompressed_RGB12_v2::write(const U8* item, U32& context)
{
  I32 diff_l = 0;
  I32 diff_h = 0;
  I32 corr;
...
LAStools::BOOL LASwriteItemCompressed_BYTE_v2::init(const U8* item, U32& context)
{
  U32 i;
  /* init state */
...
inline LAStools::BOOL LASwriteItemCompressed_BYTE_v2::write(const U8* item, U32& context)
{
  U32 i;
  I32 diff;
  for (i = 0; i < number; i++)
