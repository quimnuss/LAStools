...
inline LAStools::BOOL ByteStreamInFile::isSeekable() const
{
  return (file != stdin);
}
...
inline LAStools::BOOL ByteStreamInFile::seek(const I64 position)
{
  if (tell() != position)
  {
#if defined _WIN32 && ! defined (__MINGW32__)
...
inline LAStools::BOOL ByteStreamInFile::seekEnd(const I64 distance)
{
#if defined _WIN32 && ! defined (__MINGW32__)
