...
LAStools::BOOL LASreadItemCompressed_POINT10_v1::init(const U8* item, U32& context)
{
  U32 i;
...
LAStools::BOOL LASreadItemCompressed_GPSTIME11_v1::init(const U8* item, U32& context)
{
  /* init state */
  last_gpstime_diff = 0;
...
LAStools::BOOL LASreadItemCompressed_RGB12_v1::init(const U8* item, U32& context)
{
  /* init state */
...
LAStools::BOOL LASreadItemCompressed_WAVEPACKET13_v1::init(const U8* item, U32& context)
{
  /* init state */
  last_diff_32 = 0;
...
LAStools::BOOL LASreadItemCompressed_BYTE_v1::init(const U8* item, U32& context)
{
  /* init state */
