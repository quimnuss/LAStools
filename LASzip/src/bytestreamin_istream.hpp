...
inline LAStools::BOOL ByteStreamInIstream::isSeekable() const
{
...
inline LAStools::BOOL ByteStreamInIstream::seek(const I64 position)
{
  if (tell() != position)
  {
...
inline LAStools::BOOL ByteStreamInIstream::seekEnd(const I64 distance)
{
