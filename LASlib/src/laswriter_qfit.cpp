...
LAStools::BOOL LASwriterQFIT::refile(FILE* file)
{
...
LAStools::BOOL LASwriterQFIT::open(const char* file_name, const LASheader* header, I32 version, U32 io_buffer_size)
{
  if (file_name == 0)
  {
...
LAStools::BOOL LASwriterQFIT::open(FILE* file, const LASheader* header, I32 version)
{
  if (file == 0)
  {
...
LAStools::BOOL LASwriterQFIT::open(ByteStreamOut* stream, const LASheader* header, I32 version)
{
  if (stream == 0)
  {
...
LAStools::BOOL LASwriterQFIT::write_point(const LASpoint* point)
{
...
LAStools::BOOL LASwriterQFIT::update_header(const LASheader* header, LAStools::BOOL use_inventory, LAStools::BOOL update_extra_bytes)
{
  return TRUE;
}

I64 LASwriterQFIT::close(LAStools::BOOL update_header)
{
  I64 bytes = 0;
