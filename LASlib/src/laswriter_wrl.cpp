...
LAStools::BOOL LASwriterWRL::open(const CHAR* file_name, const LASheader* header, const CHAR* parse_string)
{
  if (file_name == 0)
  {
...
LAStools::BOOL LASwriterWRL::open(FILE* file, const LASheader* header, const CHAR* parse_string)
{
  if (file == 0)
  {
...
LAStools::BOOL LASwriterWRL::write_point(const LASpoint* point)
{
...
LAStools::BOOL LASwriterWRL::update_header(const LASheader* header, LAStools::BOOL use_inventory, LAStools::BOOL update_extra_bytes)
{
  return TRUE;
}

I64 LASwriterWRL::close(LAStools::BOOL update_header)
{
  if (file == 0)
  {
    return 0;
