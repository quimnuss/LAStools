...
LAStools::BOOL LASwaveform13reader::is_compressed() const
{
  return compressed;
}

LAStools::BOOL LASwaveform13reader::open(const char* file_name, I64 start_of_waveform_data_packet_record, const LASvlr_wave_packet_descr * const * wave_packet_descr)
{
  if (file_name == 0)
  {
...
LAStools::BOOL LASwaveform13reader::read_waveform(const LASpoint* point)
{
...
LAStools::BOOL LASwaveform13reader::get_samples()
{
  if (nbits == 8)
  {
    sampleMin = samples[0];
...
LAStools::BOOL LASwaveform13reader::has_samples()
{
  if (s_count < nsamples)
  {
    if (nbits == 8)
...
LAStools::BOOL LASwaveform13reader::get_samples_xyz()
{
  if (nbits == 8)
  {
    sampleMin = samples[0];
...
LAStools::BOOL LASwaveform13reader::has_samples_xyz()
{
  if (s_count < nsamples)
  {
