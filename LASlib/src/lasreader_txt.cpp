...
LAStools::BOOL LASreaderTXT::open(const CHAR* file_name, U8 point_type, const CHAR* parse_string, I32 skip_lines, LAStools::BOOL populate_header)
{
  if (file_name == 0)
  {
...
LAStools::BOOL LASreaderTXT::open(FILE* file, const CHAR* file_name, U8 point_type, const CHAR* parse_string, I32 skip_lines, LAStools::BOOL populate_header)
{
  int i;
...
void LASreaderTXT::set_pts(LAStools::BOOL pts)
{
...
void LASreaderTXT::set_ptx(LAStools::BOOL ptx)
{
...
LAStools::BOOL LASreaderTXT::seek(const I64 p_index)
{
  U32 delta = 0;
  if (p_index > p_count)
  {
...
LAStools::BOOL LASreaderTXT::read_point_default()
{
  if (p_count)
  {
    while (true)
...
void LASreaderTXT::close(LAStools::BOOL close_stream)
{
  if (file)
  {
...
LAStools::BOOL LASreaderTXT::reopen(const char* file_name)
{
  int i;
...
LAStools::BOOL LASreaderTXT::parse_attribute(const char* l, I32 index)
{
...
LAStools::BOOL LASreaderTXT::parse(const char* parse_string)
{
  I32 temp_i;
  F32 temp_f;
...
LAStools::BOOL LASreaderTXT::check_parse_string(const char* parse_string)
{
  const char* p = parse_string;
  while (p[0])
  {
...
LAStools::BOOL LASreaderTXTrescale::open(const CHAR* file_name, U8 point_type, const CHAR* parse_string, I32 skip_lines, LAStools::BOOL populate_header)
{
...
LAStools::BOOL LASreaderTXTreoffset::open(const CHAR* file_name, U8 point_type, const CHAR* parse_string, I32 skip_lines, LAStools::BOOL populate_header)
{
  if (!LASreaderTXT::open(file_name, point_type, parse_string, skip_lines, populate_header)) return FALSE;
  // do we need to change anything
...
LAStools::BOOL LASreaderTXTrescalereoffset::open(const CHAR* file_name, U8 point_type, const CHAR* parse_string, I32 skip_lines, LAStools::BOOL populate_header)
{
  if (!LASreaderTXT::open(file_name, point_type, parse_string, skip_lines, populate_header)) return FALSE;
  // do we need to change anything
  if (scale_factor[0] && (header.x_scale_factor != scale_factor[0]))
