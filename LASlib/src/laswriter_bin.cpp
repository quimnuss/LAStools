...
LAStools::BOOL LASwriterBIN::refile(FILE* file)
{
...
LAStools::BOOL LASwriterBIN::open(const char* file_name, const LASheader* header, const char* version, U32 io_buffer_size)
{
  if (file_name == 0)
  {
...
LAStools::BOOL LASwriterBIN::open(FILE* file, const LASheader* header, const char* version)
{
  if (file == 0)
  {
...
LAStools::BOOL LASwriterBIN::open(ByteStreamOut* stream, const LASheader* header, const char* version)
{
  if (stream == 0)
  {
...
LAStools::BOOL LASwriterBIN::write_point(const LASpoint* point)
{
  U16 echo;
...
LAStools::BOOL LASwriterBIN::update_header(const LASheader* header, LAStools::BOOL use_inventory, LAStools::BOOL update_extra_bytes)
{
  return TRUE;
}

I64 LASwriterBIN::close(LAStools::BOOL update_npoints)
{
  I64 bytes = 0;
