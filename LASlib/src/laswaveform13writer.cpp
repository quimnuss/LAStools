...
LAStools::BOOL LASwaveform13writer::open(const char* file_name, const LASvlr_wave_packet_descr * const * wave_packet_descr)
{
  if (file_name == 0)
  {
  ...
  U16 i, number = 0;
  LAStools::BOOL compressed = FALSE;
...
LAStools::BOOL LASwaveform13writer::write_waveform(LASpoint* point, U8* samples)
{
