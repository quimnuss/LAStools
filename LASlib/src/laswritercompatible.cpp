...
LAStools::BOOL LASwriterCompatibleDown::open(LASheader* header, LASwriteOpener* laswriteopener, LAStools::BOOL moveCRSfromEVLRtoVLR, LAStools::BOOL moveEVLRtoVLR)
{
  U32 i;
...
LAStools::BOOL LASwriterCompatibleDown::write_point(const LASpoint* point)
{
...
LAStools::BOOL LASwriterCompatibleDown::update_header(const LASheader* header, LAStools::BOOL use_inventory, LAStools::BOOL update_extra_bytes)
{
  return writer->update_header(header, use_inventory, update_extra_bytes);
}

I64 LASwriterCompatibleDown::close(LAStools::BOOL update_header)
{
...
LAStools::BOOL LASwriterCompatibleUp::open(LASheader* header, LASwriteOpener* laswriteopener)
{
  U32 i;
...
LAStools::BOOL LASwriterCompatibleUp::write_point(const LASpoint* point)
{
  I16 scan_angle;
  U8 extended_returns;
  U8 classification;
...
LAStools::BOOL LASwriterCompatibleUp::update_header(const LASheader* header, LAStools::BOOL use_inventory, LAStools::BOOL update_extra_bytes)
{
  return writer->update_header(header, use_inventory, update_extra_bytes);
}

I64 LASwriterCompatibleUp::close(LAStools::BOOL update_header)
{
  I64 bytes = writer->close(update_header);
