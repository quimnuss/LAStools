...
LAStools::BOOL LASinventory::init(const LASheader* header)
{
  if (header)
  {
    U32 i;
...
LAStools::BOOL LASinventory::add(const LASpoint* point)
{
...
LAStools::BOOL LASinventory::update_header(LASheader* header) const
{
  if (header)
  {
    int i;
...
LAStools::BOOL LASsummary::add(const LASpoint* point)
{
...
LAStools::BOOL LAShistogram::parse(int argc, char* argv[])
{
  int i;
  for (i = 1; i < argc; i++)
  {
...
LAStools::BOOL LAShistogram::histo(const CHAR* name, F32 step)
{
  if (strcmp(name, "x") == 0)
...
LAStools::BOOL LAShistogram::histo_avg(const CHAR* name, F32 step, const CHAR* name_avg)
{
...
LAStools::BOOL LASoccupancyGrid::add(const LASpoint* point)
{
  I32 pos_x, pos_y;
  if (grid_spacing < 0)
  {
...
LAStools::BOOL LASoccupancyGrid::add(I32 pos_x, I32 pos_y)
{
  if (grid_spacing < 0)
  {
    grid_spacing = -grid_spacing;
...
LAStools::BOOL LASoccupancyGrid::add_internal(I32 pos_x, I32 pos_y)
{
  pos_y = pos_y - anker;
...
LAStools::BOOL LASoccupancyGrid::occupied(const LASpoint* point) const
{
...
LAStools::BOOL LASoccupancyGrid::occupied(I32 pos_x, I32 pos_y) const
{
  if (grid_spacing < 0)
  {
    return FALSE;
...
LAStools::BOOL LASoccupancyGrid::active() const
{
...
LAStools::BOOL LASoccupancyGrid::write_asc_grid(const CHAR* file_name) const
{
