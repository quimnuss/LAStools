...
public:
  ...
  virtual LAStools::BOOL open(const CHAR* file_name, U8 point_type=0, const CHAR* parse_string=0, I32 skip_lines=0, LAStools::BOOL populate_header=FALSE);
  virtual LAStools::BOOL open(FILE* file, const CHAR* file_name=0, U8 point_type=0, const CHAR* parse_string=0, I32 skip_lines=0, LAStools::BOOL populate_header=FALSE);
...
private:
  ...
  LAStools::BOOL parse_attribute(const CHAR* l, I32 index);
  LAStools::BOOL parse(const CHAR* parse_string);
...
{
public:
  LAStools::BOOL open(const CHAR* file_name, U8 point_type=0, const CHAR* parse_string=0, I32 skip_lines=0, LAStools::BOOL populate_header=FALSE);
