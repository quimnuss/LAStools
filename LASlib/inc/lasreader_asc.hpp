...
public:
  ...
  virtual LAStools::BOOL open(const CHAR* file_name, LAStools::BOOL comma_not_point=FALSE);
...
{
public:
  LAStools::BOOL open(const CHAR* file_name, LAStools::BOOL comma_not_point=FALSE);
